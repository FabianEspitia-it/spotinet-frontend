...
export default function AccountsClient() {
  ...
  const filteredUsers = useMemo(() => {
    if (selectedUser || !userQuery.trim()) return [];
    return users;
  }, [users, userQuery, selectedUser]);
  ...
  const filteredAccounts = useMemo(() => {
    ...
    return accounts.filter(
      (a) =>
        ...
        !selectedAccounts.some((s) => s.id === a.id)
    );
  }, [accounts, accountQuery, selectedAccounts]);
        ...
        >
          <form onSubmit={handleLink} className="space-y-4">
            ...
            <div className="relative">
              ...
              {accountQuery.trim() && filteredAccounts.length === 0 && (
