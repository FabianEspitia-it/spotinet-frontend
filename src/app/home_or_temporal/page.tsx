      ...
      <div className="flex justify-center items-center bg-principal_blue h-screen w-full">
        <div className="text-center">
          ...
          <p className="pt-4 font-semibold text-white">
            Estamos trayendo el link de acceso, por favor espera unos segundos
          </p>
        </div>
      </div>
    );
            ...
            <div className="relative text-center bg-principal_blue border-2 border-secondary_blue rounded-lg px-8 pb-8 pt-6 max-w-lg w-full shadow-lg">
              ...
              <div className="flex justify-center mb-6 gap-x-3">
                ...
                <h2 className="text-secondary_blue text-2xl font-bold text-center mt-4">
                  Actualizar hogar o <br /> Estoy de viaje
                </h2>
              </div>
            ...
            responseMessage !==
              ...
              <div className="relative text-center bg-principal_blue border-2 border-secondary_blue rounded-lg px-8 pb-8 pt-6 max-w-lg w-full shadow-lg">
                ...
                <p className="text-white text-center text-md mb-4">
                  Haz click en el enlace para obtener tu acceso: <br />
                </p>
                <a
                  className="w-full text-secondary_blue text-xl underline border-2 py-2 rounded-lg border-secondary_blue hover:bg-secondary_blue-dark hover:bg-secondary_blue hover:text-principal_blue duration-300 block"
                  rel="noreferrer"
                  target="_blank"
                ...
                <a
                  className="w-full mt-4 bg-secondary_blue text-white rounded-xl py-2 font-semibold hover:bg-secondary_blue-dark focus:outline-none focus:ring-4 focus:ring-secondary_blue focus:ring-opacity-50 transition duration-300 block text-center"
