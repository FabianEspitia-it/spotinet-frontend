...
import { requestDisneySessionCode } from "@/lib/actions/streaming";
...
export default function SessionCode() {
  ...
  async function sendData(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      const result = await requestDisneySessionCode({ email, password });
      ...
      if (result.ok) {
        if (
          ...
          setResponseMessage(`Código de sesión: ${result.data.code}`);
